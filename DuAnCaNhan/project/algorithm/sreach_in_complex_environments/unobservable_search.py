...
def unobservable_search(cases, cols, rows):
    yield {
        "current": None,
        "frontier": [],
        "explored": set(),
        "log": "Khởi tạo Belief State (BS) gồm các trạng thái bắt đầu dự đoán..."
    }
    ...
    yield {
        ...
        "frontier": [],
        "explored": set(),
        "log": f"Tập trạng thái ban đầu có {len(initial_bs)} vị trí có thể. Mỗi vị trí có kịch bản rác riêng."
    }
